...
<div class="a-section a-spacing-double-large">
  <div class="a-box a-spacing-base"><div class="a-box-inner a-padding-extra-large">
    ...
    <form name="forgotPassword" method="post" novalidate="" class="a-spacing-none fwcim-form" data-fwcim-id="cc18bfc4">
      ...
      <div class="a-section a-spacing-large">
        <label for="ap_email" class="a-form-label"  style="padding-top: 10px">
          Enter your Phone number
        </label>
        
        <input v-model="mobile" :class="['input-group', isValid('mobile')]" type="number" maxlength="128" id="ap_email" name="email" tabindex="1" class="a-input-text a-span12 auth-required-field">
        



<div id="auth-email-missing-alert" v-if="missing_field" class="a-box a-alert-inline a-alert-inline-error auth-inlined-error-message a-spacing-top-mini" aria-live="assertive" role="alert"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
  Please Enter your Phone number
      ...
      <span class="a-button a-button-span12 a-button-primary" id="a-autoid-0"><span class="a-button-inner"><input id="continue" tabindex="3" class="a-button-input" type="submit" aria-labelledby="a-autoid-0-announce"><span class="a-button-text" aria-hidden="true" id="a-autoid-0-announce">
        Continue
      </span></span></span>
