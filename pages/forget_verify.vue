            ...
            <div class="a-section auth-pagelet-container">
              ...
              <div class="a-box a-spacing-extra-large">
                <div class="a-box-inner">
                  ...
                  <p>
                    For your security, we need to authenticate your request. We've sent an OTP to the mobile number.
                    <span
                      class="a-text-bold"
                    >+91{{phone_number}}</span>
                  ...
                  <form id="auth-pv-form" method="post" action="/ap/pv" class="a-spacing-none">
                    ...
                    <span
                      ...
                      id="a-autoid-0"
                    >
                      <span class="a-button-inner" @click="resetPassword">
                        <span
                          class="a-button-text"
                          aria-hidden="true"
                          id="a-autoid-0-announce"
                        >Reset your WENSLink account</span>
                      </span>
                    </span>
                  </form>
                </div>
