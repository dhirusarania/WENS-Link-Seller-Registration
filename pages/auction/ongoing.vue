  ...
  <section>
    <section class="navbar-spacing padding-top-30">
      <div class="v-container">
        <vs-table stripe max-items="10" pagination :data="allCompletedAuction">
          <template slot="header">
            <div class="flex flex-column">
              <h3>Completed Auction</h3>
            </div>
          </template>
          <template slot="thead">
            <vs-th sort-key="auction_id">Auction ID</vs-th>
            <vs-th sort-key="product_info">Product Name</vs-th>
            <vs-th sort-key="min_bid">Price</vs-th>
          ...
          <template slot-scope="{data}">
            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
              <vs-td :data="data[indextr].auction_id">
                <p>{{data[indextr].auction_id}}</p>
              </vs-td>

              <vs-td :data="data[indextr].product_info['product_name']">
                <p class="clamp1">{{data[indextr].product_info['product_name']}}</p>
              </vs-td>

              <vs-td :data="data[indextr].min_bid">{{data[indextr].min_bid}}</vs-td>
